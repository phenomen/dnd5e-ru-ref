...
>
	...
	<a
		...
		target="_blank">Foundry VTT RU</a
	>
	<a
		class="text-blue-500 underline hover:text-blue-300"
		href="https://vk.com/vecherniyekosti"
		target="_blank">Вечерние Кости</a
	>
	<a
		class="text-blue-500 underline hover:text-blue-300"
		href="https://vk.com/noroleplaying"
		target="_blank">NoRP</a
	>
	<a
		class="text-blue-500 underline hover:text-blue-300"
		href="https://discord.gg/AEj8YGX96m"
		target="_blank">Подземелья и Подземелья</a
	>
</div>
